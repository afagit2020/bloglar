            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-section">
                    ...
                    <p class="copyright"><strong> Developed by </strong>
                        <a href="" target="_blank">Afa Dev</a></p>
                    <ul class="icons">
                        <li><a target="_blank" href="https://www.facebook.com/ayunfadli1"><i class="ion-social-facebook-outline"></i></a></li>
                        <li><a target="_blank" href="https://twitter.com/ayunfadli"><i class="ion-social-twitter-outline"></i></a></li>
                        <li><a target="_blank" href="https://www.instagram.com/ayunfadli"><i class="ion-social-instagram-outline"></i></a></li>
